@php
    $activePage = 'home'; // nilai sesuaikan dengan halaman yang sedang aktif
@endphp
                    ...
                    <div class="row mb-8">
                        <div class="col-md-12">
                            ...
                            <div class="card bg-light border-0 rounded-4"
                                style="background-image: url(images/slider/cetakno-slider.jpeg); background-repeat: no-repeat; background-size: cover; background-position: right;">
                                <div class="card-body p-lg-12" style="border: 1px solid black; border-radius: 15px;">
                                    <h1>Welcome back! Jeffri
                                    </h1>
                            ...
                            <div class="col-lg-4 col-12 mb-6">
                                ...
                                <div class="card h-100 card-lg">
                                    ...
                                    <div class="card-body p-6">
                                        ...
                                        <!-- project number -->
                                        <div class="lh-1">
                                            <h1 class=" mb-2 fw-bold fs-2">Rp 32.000.000</h1>
                                        ...
                                        <ul class="list-unstyled mb-0">
                                            <li class="mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="8"
                                                    ...
                                                    <circle cx="8" cy="8" r="8" />
                                                        ...
                                                        Rp 4.500.000</span> (2%)</span></li>
                                            <li class="mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="8"
                                                    height="8" fill="currentColor"
                                                    class="bi bi-circle-fill text-warning" viewBox="0 0 16 16">
                                                    <circle cx="8" cy="8" r="8" />
                                                </svg> <span class="ms-1"><span class="text-dark">Refunds Rp 1.500.000</span>
                                                    (11%)</span></li>
                                            <li class="mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="8"
                                                    height="8" fill="currentColor" class="bi bi-circle-fill text-danger"
                                                    viewBox="0 0 16 16">
                                                    <circle cx="8" cy="8" r="8" />
                                                </svg> <span class="ms-1"><span class="text-dark">Order Rp 8.500.000</span>
                                                    (1%)</span></li>
                                            <li><svg xmlns="http://www.w3.org/2000/svg" width="8" height="8"
                                                    fill="currentColor" class="bi bi-circle-fill text-info"
                                                    viewBox="0 0 16 16">
                                                    <circle cx="8" cy="8" r="8" />
                                                </svg> <span class="ms-1"><span class="text-dark">Income Rp 46.500.000</span>
                                                    (86%)</span></li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="mt-6">
                                        ...
                                        <div class="mb-5">
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <span><span class="me-1 text-dark">Rp 12.000.000</span> (8.6%)</span>
                                            </div>
                                            <!-- main wrapper -->
                                            <div>
                                                <!-- progressbar -->
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <span><span class="me-1 text-dark">Rp 18.000.000</span> (86.4%)</span>
                                            </div>
                                            <div>
                                                <!-- progressbar -->
                                        ...
                                        <div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <span><span class="me-1 text-dark">Rp 6.000.000</span> (74.5%)</span>
                                            </div>
                                            <div>
                                                <!-- progressbar -->
                                    ...
                                    <div class="card-body px-6 py-8">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-4">
                                                ...
                                                <p class="mb-0">You have <a class="link-info" href="{{url('/customers')}}">2 new
                                                        notification</a></p>
                                            </div>
                                    ...
                                    <div class="card-body px-6 py-8">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-4">
                                                ...
                                                <p class="mb-0"> <a class="link-info" href="{{url('/order-list')}}">View Performance</a></p>
                                            </div>
