        ...
        <nav class="navbar navbar-light py-2">
            <div class="container justify-content-center justify-content-lg-between">
                <a class="navbar-brand" href="{ route('home') }}">
                    <img src="{{ asset('images/logo/Cetakno-crop.png')}}"
                ...
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-12 col-md-6 offset-lg-1 col-lg-4 order-lg-2 order-1">
                        <div class="mb-lg-9 mb-5">
                            ...
                            <p>Welcome back to Cetakno Admin! Enter your email and password to get started.</p>
                        </div>
                        ...
                        @else
                            <form action="{{ route('signin-pegawai') }}" method="post">
                                @csrf
                                <div class="row g-3">
                                    <!-- row -->
                                    {{-- @if (session('fail'))
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" id="inputEmail4"
                                            placeholder="Enter Username" name="EMAIL_PEGAWAI" required autofocus>
                                        {{-- @error('username_cust')
                                            {{ $message }}
                                        @enderror --}}
                                        {{-- @error('record')
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="password-field position-relative">
                                            <input type="password" id="fakePassword" placeholder="Enter Password"
                                                class="form-control" name="PASSWORD_PEGAWAI" required>
